        ...
        <section class="col-md-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3>Edit Drinks
                <a href="{{route('drink.view')}}" class="btn btn-sm btn-info float-right">
                  <i class="fa fa-list"></i> Drinks List </a>
              </h3>
            </div><!-- /.card-header -->
            <div class="card-body">

              <form method="post" action="{{route('drink.update',$editData->id)}}" enctype="multipart/form-data">
                  @csrf
                  <div class="form-row">
