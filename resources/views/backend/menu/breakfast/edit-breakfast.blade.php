        ...
        <section class="col-md-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3>Add Breakfast
                <a href="{{route('breakfast.view')}}" class="btn btn-sm btn-info float-right"><i class="fa fa-list"></i> Breakfast List </a>
              </h3>
            </div><!-- /.card-header -->
            <div class="card-body">

              <form method="post" action="{{route('breakfast.update',$editData->id)}}" enctype="multipart/form-data">
                  @csrf
                  <div class="form-row">
