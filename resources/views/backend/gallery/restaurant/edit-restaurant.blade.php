        ...
        <section class="col-md-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3>Add Restaurant
                <a href="{{route('restaurant.view')}}" class="btn btn-sm btn-info float-right">
                  <i class="fa fa-list"></i> Restaurant List </a>
              </h3>
            </div><!-- /.card-header -->
            <div class="card-body">

              <form method="post" action="{{route('restaurant.update',$editData->id)}}" enctype="multipart/form-data">
                  @csrf
                  <div class="form-row">
                    <div class="col-md-8">
                      <div class="row">
