        ...
        <section class="col-md-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3>Add Food
                <a href="{{route('food.view')}}" class="btn btn-sm btn-info float-right">
                  <i class="fa fa-list"></i> Food List </a>
              </h3>
            </div><!-- /.card-header -->
            <div class="card-body">

              <form method="post" action="{{route('food.update',$editData->id)}}" enctype="multipart/form-data">
                  @csrf
                  <div class="form-row">
                    <div class="col-md-8">
                      <div class="row">
